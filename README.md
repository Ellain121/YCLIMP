...
Короткий экскурс:<br />
Перключатся по окнам: 1, 2, 3
В правом окне переключаются режимы кнопками Y,L,A, где Y-яндекс, L-локальное, A-бд приложения
Чтобы слушать треки нужно их перекинуть в левое окно.
Enter открывать папки.
Пробел докидывает треки рекурсивно в левое окно.
Ctrl + Пробел тоже самое что пробел, только предварительно чистит левое окно.
