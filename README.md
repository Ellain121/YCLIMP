...
Есть небольшая/неполная документация doxygen - https://yclimp.excitedto.cyou/annotated.html <br />
...
Как запустить:<br />
1) Наличие g++ с поддержкой C++ 20, либо нужно изменить компилятор на свой, но нужно наличие поддержки C++20
2) sh requirements.txt # Предварительно проверить его содержимое, чтобы не поломать себе ничего
...
Короткий экскурс:<br />
* Перключатся по окнам: 1, 2, 3<br />
* В правом окне переключаются режимы кнопками Y,L,A, где Y-яндекс, L-локальное, A-бд приложения<br />
* Чтобы слушать треки нужно их перекинуть в левое окно.<br />
* Enter открывать папки.<br />
* Пробел докидывает треки рекурсивно в левое окно.<br />
* Ctrl + Пробел тоже самое что пробел, только предварительно чистит левое окно.<br />

!Если приложение крашнулось, то сразу не встанет, так как локальный порт для связи с клиентом питона будет занят некоторое время.
